...
type
  TMaterialIconForm = class(TForm)
    ...
    procedure SearchLabelDblClick(Sender: TObject);
  private
    FFont: IFont;
    FGlyph: IFont;
    FLargeGlyph: IFont;
...
begin
  OpenURL('https://www.getlazarus.org/apps/matview/#help');
end;

procedure TMaterialIconForm.SearchLabelDblClick(Sender: TObject);
begin
  SearchLabel.Caption := GraphicsEngine;
end;
